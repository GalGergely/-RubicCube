/* autogenerated by Processing revision 1289 on 2023-03-09 */
...
class Cube {
  ...
  public ArrayList<Cubie> checkIfAllCorenrsAreSolved() {
...
public class RubiksCubeLogic  {
    ...
    public OldPochmanAlgorithm breakPlugging(Cubie cubie) {
        OldPochmanAlgorithm algo = null;
    ...
    public void SolveOneCorner(int id) {
        print("buffer id: " + id);
    ...
    public String[] mirrorArray(String[] array) {
        String[] returnarray = {};
